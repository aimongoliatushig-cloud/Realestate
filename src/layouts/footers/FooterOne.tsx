...
import footerLogo_2 from "@/assets/images/logo/logoua.png"
                     ...
                     <div className={`footer-intro ${style ? "position-relative z-1" : ""}`}>
                        <div className="bg-wrapper">
                           <div className="logo mb-20">
                            ...
                            <p className="mb-60 lg-mb-40 md-mb-20">Улаанбаатар хот, Сүхбаатар дүүрэг, 1-р хороо</p>
                            <h6>ХОЛБОО БАРИХ</h6>
                            <Link href="tel:77171111" className={`email tran3s mb-70 lg-mb-50 ${style ? "font-garamond" : "fs-24 text-decoration-underline"}`}>7717 1111</Link>
