...
const feedback_data: DataType[] = [
...

   {
      id: 1,
      page: "home_5",
      desc: "Гайхалтай! Үр ашгийг нэмэгдүүлж, ажлыг хялбаршуулсан. Маш их санал болгож байна!",
      title: "Бат-Эрдэнэ,",
      country: "Улаанбаатар",
   ...
   },
   {
      id: 2,
      page: "home_5",
      desc: "Мөрөөдлийн гэрээ олсон. Тэдэнтэй хамтран ажиллах сайхан байлаа. Цагийг хэмнэж, ажлыг хялбаршуулсан. Баярлалаа.",
      title: "Оюунчимэг,",
      country: "Улаанбаатар",
   ...
   },
   {
      id: 3,
      page: "home_5",
      desc: "Үр дүнтэй, эелдэг үйлчилгээ, биднийг төгс удирдан чиглүүлсэн. Шинэ гэртээ сэтгэл хангалуун байна. Баярлалаа!",
      title: "Ганболд,",
      country: "Улаанбаатар",
