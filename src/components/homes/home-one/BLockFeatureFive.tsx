            ...
            <div className="row">
               <div className="col-xl-8 m-auto">
                  <div className="title-one text-center mb-35 lg-mb-20">
                     <h3>Бид танд <span>мөрөөдлийн гэрээ<Image src={titleShape} alt="" className="lazy-img" /></span> <br /> олоход туслахад бэлэн</h3>
                     <p className="fs-24 color-dark">Энэхүү энгийн алхмуудаар бидэнтэй хамт эхлэхэд хялбар</p>
                  </div>
               </div>
            </div>
