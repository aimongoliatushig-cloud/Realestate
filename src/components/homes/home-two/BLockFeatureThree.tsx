         ...
         <div className="row align-items-center mb-100 lg-mb-50 md-mb-20">
            <div className="col-xxl-6 col-xl-5 col-lg-8">
               <div className="title-one">
                  <h2 className="font-garamond m0 lh-1 position-relative">Бид танд тохирох үл хөдлөх хөрөнгийг олоход туслах болно.
                     <Image src={lineShape} alt="" className="lazy-img shapes shape_02" /></h2>
               </div>
            </div>
            <div className="col-xxl-4 col-xl-4">
               <p className="fs-24 m0 color-dark lg-pt-30 lg-pb-50">Бид 745,000 гаруй орон сууц, байшинг худалдаа, түрээсийн зориулалтаар санал болгож байна.</p>
            </div>
            <div className="col-xxl-2 col-xl-3 d-inline-flex justify-content-xl-end">
                <Link href="#" className="btn-five text-uppercase rounded-0">Эхлэх</Link>
            </div>
         </div>
