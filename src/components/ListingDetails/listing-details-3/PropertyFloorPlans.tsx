               ...
               <h2 className="accordion-header">
                  <button className={`accordion-button ${item.id === 1 ? "" : "collapsed"}`} type="button"
                     ...
                     <div className="d-flex justify-content-between w-100">
                         <span className="fw-500 color-dark">1-р давхар</span>
                        <ul className="style-none d-flex flex-wrap align-items-center justify-content-between">
                           <li>
                              <Image src={floorIcon_1} alt="" className="lazy-img icon" />
                              <span><span className="fw-500">{item.features.sqft}</span> м2</span>
                           </li>
                           <li>
                              <Image src={floorIcon_2} alt="" className="lazy-img icon" />
                           <span><span className="fw-500">0{item.features.bed}</span> унтлагын</span>
                            </li>
                            <li>
                               <Image src={floorIcon_3} alt="" className="lazy-img icon" />
                               <span><span className="fw-500">0{item.features.bath}</span> угаалгын</span>
                           </li>
                        </ul>
                     </div>
                  </button>
